...
Rails.application.routes.draw do
    ...
    resources :representatives do
        ...
        get '/my_news_item/new' => 'my_news_items#new',
            :as                                                    => :new_my_news_item
    		get '/my_news_item/new_page2' => 'my_news_items#new_page2', :as => :new_page2_my_news_item
				post '/my_news_item/new_article' => 'my_news_items#new_article', :as => :new_article_representative_my_news_item
